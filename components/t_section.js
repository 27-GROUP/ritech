      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            ...
            <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">We are all passionate and impact-driven </p>
          </div>
            ...
            {team_list.map((team_list) => (
              <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                  ...
                  <span class="text-gray-500 font-bold dark:text-gray-400">{team_list.role}</span>
                  <p class="mt-3 mb-4 font-light italic text-gray-500 dark:text-gray-400">{team_list.experience}</p>
